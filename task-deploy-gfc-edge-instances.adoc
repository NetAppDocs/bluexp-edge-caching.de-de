...
. Konfigurieren Sie Ihre Windows Server-VM, treten Sie der Active Directory-Domäne des Unternehmens bei und fahren Sie mit dem Konfigurationsabschnitt „Global File Cache Edge“ fort.
...
.Nächste Schritte
Weitere Informationen zur erweiterten Konfiguration von Global File Cache Edge finden Sie im https://repo.cloudsync.netapp.com/gfc/Global%20File%20Cache%202.2.0%20User%20Guide.pdf["NetApp Global File Cache User Guide"^].
